                    ...
                    <div class="header-left-part d-flex align-items-center flex-grow-1 w-100">
                        <div class="header-search w-100">
                            <form class="search-form" action="https://wpthemebooster.com/demo/themeforest/html/kleon/search.php">
                                ...
                                <button type="submit" class="btn"><img src="{{ asset('admin/assets/img/svg/search.svg')}}" alt=""></button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="header-right-part d-flex align-items-center flex-shrink-0">
                        <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
                            <li class="nav-item nav-color-switch d-flex align-items-center gap-3">
                                <div class="sun"><img src="{{ asset('admin/assets/img/sun.svg')}}" alt="img"></div>
                                <div class="switch">
                                ...
                                <div class="moon"><img src="{{ asset('admin/assets/img/moon.svg')}}" alt="img"></div>
                            </li>
                            ...
                            <div class="form-check form-check-inline with-layout-image m-0">
                                ...
                                <label class="form-label mb-0" for="verticalNav">
                                    <span class="d-inline-block mb-2">
                                        <img class="light-version img-fluid rounded-1" src="{{ asset('admin/assets/img/customizer/vertical-light.png')}}" alt="img">
                                        <img class="dark-version img-fluid rounded-1" src="{{ asset('admin/assets/img/customizer/vertical-dark.png')}}" alt="img">
                                    </span>
                        ...
                        <div class="col-4">
                            <div class="form-check form-check-inline with-layout-image m-0">
                                ...
                                <label class="form-label mb-0" for="horizontalNav">
                                    <span class="d-inline-block mb-2">
                                        <img class="light-version img-fluid rounded-1" src="{{ asset('admin/assets/img/customizer/horizontal-light.png')}}" alt="img">
                                        <img class="dark-version img-fluid rounded-1" src="{{ asset('admin/assets/img/customizer/horizontal-dark.png')}}" alt="img">
                                    </span>
                        ...
                        <div class="col-4">
                            <div class="form-check form-check-inline with-layout-image m-0">
                                ...
                                <label class="form-label mb-0" for="comboNav">
                                    <span class="d-inline-block mb-2">
                                        <img class="light-version img-fluid rounded-1" src="{{ asset('admin/assets/img/customizer/combo-light.png')}}" alt="img">
                                        <img class="dark-version img-fluid rounded-1" src="{{ asset('admin/assets/img/customizer/combo-dark.png')}}" alt="img">
                                    </span>
                ...
                <div class="inner-contents">
                    <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                        ...
                        <div class="right-part">
                            <a href="assets/img/kleon-invoice.pdf" class="btn btn-primary rounded-2 ff-heading fs-18 fw-bold py-4" download><i class="bi bi-pie-chart-fill me-1"></i> Download Report</a>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                                <img src="{{ asset('admin/assets/img/clients/1.jpg')}}" alt="img">
                                                            </div>
                                                            <div>
                                                    ...
                                                    <td>
                                                        <div class="dropdown text-end">
                                                            ...
                                                            <div class="dropdown-menu p-0">
                                                                ...
                                                                <a class="dropdown-item" href="{{ asset('admin/assets/img/kleon-invoice.pdf')}}" download><i class="bi bi-download"></i></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                                <img src="{{ asset('admin/assets/img/clients/2.jpg')}}" alt="img">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                                <img src="{{ asset('admin/assets/img/clients/3.jpg')}}" alt="img">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                                <img src="{{ asset('admin/assets/img/clients/4.jpg')}}" alt="img">
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                                <img src="{{ asset('admin/assets/img/clients/5.jpg')}}" alt="img">
                                                            </div>
                                                            <div>
