                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8 text-start">
                                    <h1 class="fs-4 text-white">Selamat Datang</h1>
                                    <p class="display-1 text-white mb-5 animated slideInRight">Peternakan Sapi Terbaik Di Jawa Timur</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-8 text-end">
                                    ...
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Sapi Perah
                                       Terbaik</h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6 position-relative wow fadeIn" data-wow-delay="0.7s">
                            <div class="about-experience bg-secondary rounded">
                                ...
                                <small class="fs-5 fw-bold">Berpengalaman Selama</small>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="section-title bg-white text-start text-primary pe-3">Kenapa Harus Ternak Mantha!</p>
                    <h1 class="mb-4">Beberapa Alasan Mengapa Orang Memilih Kami!</h1>
                    <p class="mb-4">Karena kami memberi pelayanan yang terbaik kepada setiap Costumer</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Memberi Informasi Akurat</p>
                        ...
                        <div class="row g-0">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                                <div class="text-center bg-primary py-5 px-4">
                                    ...
                                    <span class="fs-5 fw-semi-bold text-secondary">Berpengalaman Selama</span>
                                </div>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="text-center bg-secondary py-5 px-4">
                                    ...
                                    <span class="fs-5 fw-semi-bold text-primary">Memenangkan Penghargaan</span>
                                </div>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="text-center bg-secondary py-5 px-4">
                                    ...
                                    <span class="fs-5 fw-semi-bold text-primary">Total Ternak</span>
                                </div>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                                <div class="text-center bg-primary py-5 px-4">
                                    ...
                                    <span class="fs-5 fw-semi-bold text-secondary">Costumer Puas</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="mb-5">Apa Manfaat Ternak Sapi</h1>
            </div>
                ...
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Seleksi Hewan Terbaik</h4>
                                <p class="mb-4">Memilih Bibit-bibit Ternak Sapi Terbaik.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Pemuliaan dan Kedokteran Hewan</h5>
                            <p class="mb-4">Rutin Mengecheck Kesehatan Dan Gizi Setiap Ternak.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Perawatan & Pemerahan</h5>
                            <p class="mb-4">Ternak Selalu Rutin Diberi Vitamin dan Memerah susu dari 
                                Sapi Perah yang sudah siap perah</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-4">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">PRODUK SUSU</a>
                            <span class="text-primary me-1">$19.00</span>
                            <span class="text-decoration-line-through">$29.00</span>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/kulit.jpg" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i
                                        class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">KULIT</a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/Pupuk kandang 1.jpg" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i
                                        class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">PUPUK KANDANG</a>
                            <span class="text-primary me-1">$19.00</span>
                            <span class="text-decoration-line-through">$29.00</span>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="mb-5">Tim yang Berpengalaman</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="img/oktavia.jpg" alt="">
                        <h5>Samantha Oktavia</h5>
                        <p class="text-primary">PEMILIK</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="img/qiqi.jpg" alt="">
                        <h5>Rizqi Nur Fadlia Salsabila</h5>
                        <p class="text-primary">DOKTER HEWAN</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="img/rere.jpg" alt="">
                        <h5>Renatalia Karisma</h5>
                        <p class="text-primary">AHLI GIZI TERNAK</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Kepanjen , Malang , Jawa Timur , Indonesia</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+86549762107</p>
                ...
                {{-- <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-1">Senin - Rabu</p>
                    <h6 class="text-light">08:25 - 14:00 </h6>
                    <p class="mb-1">Kamis - Sabtu</p>
                    <h6 class="text-light">09:00 - 15:00 </h6>
